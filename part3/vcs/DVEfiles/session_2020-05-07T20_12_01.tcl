...
# DVE full session
# Saved on Thu May 7 20:12:00 2020
# Designs open: 1
...
#   Group core_top signal count = 29
#   Group cntx_top_1 signal count = 14
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{8 31} {1538 866}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 170} {height 596} {dock_state left} {dock_on_new_line true} {child_hier_colhier 182} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 395} {height 596} {dock_state left} {dock_on_new_line true} {child_data_colvariable 193} {child_data_colvalue 136} {child_data_coltype 98} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1530} {height 140} {dock_state bottom} {dock_on_new_line true}}
...
gui_sg_addsignal -group "$_session_group_2" { tb_aes.dut.core_top.rstn tb_aes.dut.core_top.rndNo tb_aes.dut.core_top.enbSB tb_aes.dut.core_top.enbSR tb_aes.dut.core_top.enbMC tb_aes.dut.core_top.enbAR tb_aes.dut.core_top.enbKS tb_aes.dut.core_top.accept tb_aes.dut.core_top.cipher_text tb_aes.dut.core_top.cipher_key tb_aes.dut.core_top.buffer_cipher_in tb_aes.dut.core_top.buffer_cipher_out_ip0 tb_aes.dut.core_top.buffer_cipher_out_ip1 tb_aes.dut.core_top.buffer_cipher_out_ip2 tb_aes.dut.core_top.buffer_cipher_out_ip3 tb_aes.dut.core_top.buffer_cipher_out tb_aes.dut.core_top.clk tb_aes.dut.core_top.plain_text tb_aes.dut.core_top.buffer_text_A_ip0 tb_aes.dut.core_top.buffer_text_A_ip1 tb_aes.dut.core_top.buffer_text_A_ip2 tb_aes.dut.core_top.buffer_text_A_ip3 tb_aes.dut.core_top.buffer_text_A tb_aes.dut.core_top.buffer_text_B tb_aes.dut.core_top.buffer_text_C tb_aes.dut.core_top.buffer_text_D tb_aes.dut.core_top.buffer_text_E tb_aes.dut.core_top.rndNo tb_aes.dut.core_top.N }
...
set _session_group_3 cntx_top_1
gui_sg_create "$_session_group_3"
set cntx_top_1 "$_session_group_3"

gui_sg_addsignal -group "$_session_group_3" { tb_aes.dut.cntx_top.enbMC tb_aes.dut.cntx_top.rndNo tb_aes.dut.cntx_top.enbKS tb_aes.dut.cntx_top.rstn tb_aes.dut.cntx_top.i tb_aes.dut.cntx_top.rndNo_prev tb_aes.dut.cntx_top.enbAR tb_aes.dut.cntx_top.N tb_aes.dut.cntx_top.enbSB tb_aes.dut.cntx_top.clk tb_aes.dut.cntx_top.done tb_aes.dut.cntx_top.accept tb_aes.dut.cntx_top.start tb_aes.dut.cntx_top.enbSR }
gui_set_radix -radix {decimal} -signals {V1:tb_aes.dut.cntx_top.N}
gui_set_radix -radix {twosComplement} -signals {V1:tb_aes.dut.cntx_top.N}
...
catch {gui_list_select -id ${Hier.1} {tb_aes.dut.cntx_top}}
...
gui_list_show_data -id ${Data.1} {tb_aes.dut.cntx_top}
